...
ALTER TABLE USER_PROFILE
    ADD CONSTRAINT FK_USER_PROFILE_01 FOREIGN KEY (PROFILE_ID) REFERENCES PROFILE (ID);

ALTER TABLE USER_PROFILE
    ADD CONSTRAINT FK_USER_PROFILE_02 FOREIGN KEY (USER_ID) REFERENCES USER (ID);
